"""
EcoPin Image Validation — Experiment 3.2 Inference Service (Production)
========================================================================
...
def _log(msg):
    sys.stderr.write(f"[classifier] {msg}\n")
...
_log(f"Checkpoint  : {ckpt_kb:.1f} KB  ✓ exists")
...
try:
    ...
    classifier.eval()
    # Sanity: check first layer shape matches 512-d CLIP embedding
...
class Handler(BaseHTTPRequestHandler):
    def log_message(self, fmt, *args):
        sys.stderr.write(f"[classifier] {self.address_string()} — {fmt % args}\n")
